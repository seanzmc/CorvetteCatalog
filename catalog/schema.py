...
TABLES = {
    ...
    "model_presentation": ("source_workbook:t source_option_sheet:t rule_mapping_sheet:t price_rules_sheet:t color_overrides_sheet:t interior_source_sheet:t dataset_name:t export_slug:t setup_card_subtitle:t setup_eyebrow:t setup_title:t setup_description:t", "model_id"),
    ...
    "direct_rule": ("source_note:t legacy_id:t source_id:@entity target_id:@entity effect:t runtime_action:t explanation:t", "model_id,legacy_id"),
    ...
    "runtime_step": ("source:t step_key:t label:t runtime_order:i active:b navigable:b", "model_id,step_key"),
