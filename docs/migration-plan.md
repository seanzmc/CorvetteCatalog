...
| D — Form parity — authorized, not implemented | Generate all six model contracts directly from the candidate catalog | Exact business behavior and meaningful output ordering preserved |
